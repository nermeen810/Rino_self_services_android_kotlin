...
data class Item(@SerializedName("id")var id:Int?, @SerializedName("amount") var amount:Double?, @SerializedName("beneficiary") var beneficiary:String?, @SerializedName("date") var date:String, @SerializedName("department") var department:String, @SerializedName("status_code") var statusCode:String, @SerializedName("status")var status:String, @SerializedName("step")var step:Int, @SerializedName("status_date") var statusDate:String, @SerializedName("action") var action:Action, @SerializedName("current") var current:Current){}
