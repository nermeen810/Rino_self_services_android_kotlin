...
class PeriodAdapter(private var periodList: ArrayList<String>,private val paymentHomeViewModel: PaymentHomeViewModel) : RecyclerView.Adapter<PeriodAdapter.PeriodViewHolder>(){
    ...
    override fun onBindViewHolder(holder: PeriodViewHolder, position: Int) {
       // Log.e("lastPosition",FilteredHistoryViewModel.lastSelectedPos.toString())
        ...
        if (lastSelectedCard == null && position == PaymentHomeViewModel.lastSelectedPos) {
            Log.e("period",PaymentHomeViewModel.periodTimeList_en[PaymentHomeViewModel.lastSelectedPos])
    ...
    inner class PeriodViewHolder(val binding: PeriodItemBinding) :
        ...
        fun bind(period: String,position: Int) {
            ...
            binding.categoryCard.setOnClickListener {
                PaymentHomeViewModel.lastSelectedPos = position
                Log.e("lastPos",PaymentHomeViewModel.lastSelectedPos.toString())
                paymentHomeViewModel.getPaymentData()
                lastSelectedCard?.setCardBackgroundColor(
                    ContextCompat.getColor(
                        it.context,
                        R.color.white
